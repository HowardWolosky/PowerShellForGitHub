...
@{
    ...
    NestedModules = @(
        ...
        'GitHubPullRequestReviewRequests.ps1',
        'GitHubPullRequestReviews.ps1',
    ...
    FunctionsToExport = @(
        ...
        'Get-GitHubPullRequestCommit',
        'Get-GitHubPullRequestFile',
        'Get-GitHubPullRequestReview',
        'Get-GitHubPullRequestReviewComment',
        'Get-GitHubPullRequestReviewRequest',
        'Get-GitHubRateLimit',
        'Get-GitHubReaction',
        ...
        'New-GitHubPullRequestReviewRequest',
        'New-GitHubRelease',
        ...
        'Remove-GitHubPullRequestReview',
        'Remove-GitHubPullRequestReviewRequest',
    ...
    AliasesToExport = @(
        ...
        'Delete-GitHubPullRequestReview',
        'Delete-GitHubPullRequestReviewRequest',
        'Delete-GitHubReaction',
        'Delete-GitHubRelease',
        'Delete-GitHubReleaseAsset',
        'Delete-GitHubRepository',
        'Delete-GitHubRepositoryBranch',
        'Delete-GitHubReviewRequest',
        'Dismiss-GitHubPullRequestReview',
        'Fork-GitHubGist',
        'Get-GitHubAsset',
        'Get-GitHubBranch',
        'Get-GitHubComment',
        'Get-GitHubReviewRequest',
        'New-GitHubAsset',
        'New-GitHubAssignee',
        'New-GitHubBranch',
        'New-GitHubComment',
